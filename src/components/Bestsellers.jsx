...
//       {/* Toast Notification */}
//       {showToast && (
//         <div className={`fixed top-4 right-4 px-6 py-3 rounded-lg shadow-xl z-50 animate-slide-down ${
//           toastType === 'success' ? 'bg-green-600' : 
//           toastType === 'error' ? 'bg-red-600' : 'bg-[#6b2314]'
...
//       {/* Pro UI Grid Layout matching the exact reference image */}
//       <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
//         {bestSellers.map((product) => (
//           <div
//             key={product._id}
//             className="bg-[#fff3df] rounded-md border border-[#edd5b9] shadow-sm overflow-hidden hover:shadow-xl transition-all duration-300 relative group p-3 flex flex-col justify-between"
//           >
//             <div>
//               {/* Wishlist Button - Floating Heart Icon */}
//               <button
//                 onClick={() => handleWishlistToggle(product._id)}
//                 disabled={wishlistLoading === product._id}
//                 className="absolute top-5 right-5 w-9 h-9 bg-white/90 backdrop-blur-sm rounded-full shadow-md flex items-center justify-center hover:bg-white transition-colors z-10 cursor-pointer"
//               >
//                 <Heart 
//                   className={`w-5 h-5 transition-colors ${
//                     isInWishlist(product._id) 
...
//               {/* Product Info */}
//               <div className="px-1">
//                 <h3 className="text-sm sm:text-base font-medium text-[#4a2e18] line-clamp-2 min-h-[44px] mb-2 group-hover:text-[#6b2314] transition-colors">
//                   {product.name}
//                 </h3>
                
//                 <div className="flex items-center gap-2 mb-2">
//                   <span className="text-xs px-2 py-0.5 bg-[#fdf2f0] text-[#8b3a2b] rounded font-medium">
//                     {product.category?.name || 'General'}
//                   </span>
//                   {product.stock > 0 ? (
...
//             {/* Reference Image Style Action Buttons: BUY NOW + Cart Icon Button */}
...
//                   product.stock > 0 
//                     ? 'bg-[#d97743] hover:bg-[#c36534] text-white shadow-sm' 
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        {bestSellers.map((product) => (
          ...
          >
            ...
            {/* Action Buttons: Red BUY NOW + Cart Icon Button */}
            <div className="flex items-center gap-2">
              <button 
                onClick={() => handleAddToCart(product._id)}
                disabled={product.stock === 0}
