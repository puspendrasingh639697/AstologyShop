...
const RudrakshaMalas = () => {
  ...
  // ✅ Sirf Rudraksha + Gemstones wale products
  const rudrakshaOnly = products.filter((p) => {
    const catName = (p.category?.name || '').toLowerCase();
    return (
      catName.includes('rudraksha') ||
      catName.includes('mala') ||
      catName.includes('gemstone')
    );
  });
      ...
      <div className="max-w-[1400px] mx-auto">
        ...
        <div className="mb-8 border-b border-stone-300 pb-4">
          ...
          <p className="text-xs text-stone-500 mt-1">
            Authentic Rudraksha beads, malas, and certified gemstones for spiritual healing
          </p>
        </div>
